...
package com.example.kubernetesloadbalancer.name;
...
public class NameController {
	...
	private final String hostName = System.getenv("HOSTNAME")==null? "N/A":System.getenv("HOSTNAME") ;
	 ...
	 */
	@GetMapping("/name")
	public Mono<String> getName(@RequestParam(value = "delay", required = false, defaultValue = "0") int delayValue) {
